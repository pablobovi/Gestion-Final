...
?>
  <select data-placeholder="Productos" class="form-control chosen-select" tabindex="4" name="idproducto" id="inputidproducto">
      ...
      while ($row_productos=mysql_fetch_array($q_productos)){ ?>
          <option value="<?php echo $row_productos['idproducto']?>"><?php echo $row_productos['idproducto']?> - <?php echo $row_productos['nombreproducto']?> <?php echo $row_productos['marca']?> <?php echo $row_productos['talle']?></option>
        <?php } ?>
  </select>  
