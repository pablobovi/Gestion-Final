...
<tr>
<tr>
	<td><div align='right'>Talle: </div></td>
	<td><div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><input class="form-control" type="text" name="talleproducto" value="<?php echo $row_producto['talle'] ?>"></div></td>
</tr>
