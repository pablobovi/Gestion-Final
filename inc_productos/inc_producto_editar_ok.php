<?php
	...
	$update_producto="UPDATE producto SET nombreproducto='$nombreproducto',marca='$marcaproducto',talle='$talleproducto', stockproducto='$stockproducto', porcentajeganancia='$porcganancia', stockcritico='$stockcritico', preciocompra='$preciocompra', categoriaproducto_idcategoriaproducto='$idcategoriaproductos', precioventa='$preciopublico'
