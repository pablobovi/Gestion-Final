<?php
	mysql_select_db($database_conexion_smile,$conexion_smile);
	 ...
	 $talleproducto=$_POST['talleproducto'];
	...
	$alta_producto = "INSERT INTO producto (nombreproducto, marca, talle, stockproducto, porcentajeganancia, precioventa, preciocompra, stockcritico, categoriaproducto_idcategoriaproducto)
	 VALUES ('$nombreproducto',' $marcaproducto', '$talleproducto','$stockproducto', '$porcganancia', '$preciopublico', '$preciocompra', '$stockcritico', '$idcategoriaproductos')";
