	...
	if ($num_total_registros>0) {?>
		<table class="table">
			<tr>
				...
				<th class="col-xs-1 col-sm-1 col-md-1 col-lg-1">Talle</th>
...
<td class="danger" class="col-xs-1 col-sm-1 col-md-1 col-lg-1"><?php echo $row_producto['idproducto'] ?></td>
	 		...
	 		<td class="danger" class="col-xs-2 col-sm-2 col-md-2 col-lg-2"><?php echo $row_producto['talle'] ?></td>
	 		...
	 		<td class="warning" class="col-xs-2 col-sm-2 col-md-2 col-lg-2"><?php echo $row_producto['talle'] ?></td>
	 	...
	 	<?php } ?>	
           ...
           <td class="col-xs-1 col-sm-1 col-md-1 col-lg-1"><?php echo $row_producto['idproducto'] ?></td>
	 		...
	 		<td class="col-xs-2 col-sm-2 col-md-2 col-lg-2"><?php echo $row_producto['talle'] ?></td>
