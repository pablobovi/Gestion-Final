...
<div class="panel panel-default">
    <a href="#page-stats" class="panel-heading" data-toggle="collapse">Cantidad de ventas por rubro - <?php echo date("Y") ?></a>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                <div class="knob-container">
                    ...
                    <h3 class="text-muted text-center">Indumentaria</h3>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                <div class="knob-container">
                    ...
                    <h3 class="text-muted text-center">Accesorios</h3>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                <div class="knob-container">
                    ...
                    <h3 class="text-muted text-center">Calzados</h3>
                </div>
            </div>
        </div>
    </div>
